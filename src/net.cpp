...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "MinZuCoin"+ FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
  {"seed0","120.26.61.170"},
    ...
    {"seed7", "dnsseed7.zaobi.org"},
    {"seed8", "dnsseed6.zaobi.org"},
    {"seed","211.149.233.94"}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. MinZuCoin is probably already running."), addrBind.ToString().c_str());
        else
